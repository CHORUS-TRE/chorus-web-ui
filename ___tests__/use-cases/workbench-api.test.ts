...
import { Workbench, WorkbenchCreateModel, WorkbenchUpdateModel } from '~/domain/model'
...
describe('WorkbenchDataSourceImpl', () => {
  ...
  describe('create', () => {
    ...
    it('should throw error when API response is empty', async () => {
      ...
      await expect(dataSource.create(MOCK_API_CREATE)).rejects.toThrow('Error creating workbench');
    });
  });
  ...
  describe('get', () => {
    ...
    it('should throw error when API response is empty', async () => {
      ...
      await expect(dataSource.get('1')).rejects.toThrow('Error fetching workbench');
    });
  });
  ...
  describe('delete', () => {
    ...
    it('should throw error when API response is empty', async () => {
      ...
      await expect(dataSource.delete('1')).rejects.toThrow('Error deleting workbench');
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw error when API response is empty', async () => {
      ...
      await expect(dataSource.update(MOCK_API_UPDATE)).rejects.toThrow('Error updating workbench');
    });
  });
});
