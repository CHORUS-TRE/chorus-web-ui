  ...
  return (
    <LayoutFullScreen>
      <main className="w-screen h-screen flex items-center border-yellow-400 border-solid border-0 overflow-hidden">
        <Sidebar />
        {type === WorkbenchType.files && <Image  width={100} height={100}  src="/workbench-filemanager-placeholder.jpg" alt="workbench" className="w-full  h-full" />}
        {type === WorkbenchType.apps && <Image  width={100} height={100} src="/workbench-placeholder-1383-837.png" alt="workbench" className="w-full h-full" />}
