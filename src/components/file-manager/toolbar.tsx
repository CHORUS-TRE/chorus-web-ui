      ...
      <div className="flex items-center gap-2">
        ...
        {/* <div className="grid grid-flow-col grid-rows-1 gap-4">
          <div className="flex items-center justify-end gap-0">
            <Button
              variant="ghost"
              className={`${viewMode === 'grid' ? 'border border-accent bg-primary/20 text-accent' : 'text-accent'}`}
            ...
            <Button
              variant="ghost"
              className={`${viewMode === 'list' ? 'border border-accent bg-primary/20 text-accent' : 'text-accent'}`}
              onClick={onToggleViewMode}
              id="list-button"
