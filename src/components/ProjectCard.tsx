...
export default function ProjectCard({ setShowModal }: { setShowModal: Dispatch<SetStateAction<boolean>> }) {
  const [showAppMenu, setShowAppMenu] = useState(false)

  return (<div className="p-5 rounded-xl text-white  border-slate-700 border-solid border bg-slate-900 bg-opacity-50 backdrop-blur-sm">

    <div className="flex flex-row gap-8 ">
      <div className="w-1/2 flex flex-col py-3">
        <div className="flex flex-row gap-4 mb-4">
          <img src="/chuv.png" />
          <p className="text-md"> Centre de la science des données biomédicales </p>
        </div>

        <div className="mb-4">
          <p className="text-md">Centre Hospitalier Universitaire de Lausanne (CHUV)</p>
          <p className="text-sm">Professor Philippe Ryvlin</p>
          <p className="text-sm">Lausanne, Switzerland</p>
