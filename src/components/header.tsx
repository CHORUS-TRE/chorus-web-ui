...
export function Header() {
  ...
  return (
    <header className="sticky top-0 flex h-14 items-center gap-8 bg-background bg-slate-50  px-4 pb-16 sm:static sm:h-auto  sm:gap-1 sm:px-6 sm:py-1 ">
      <nav className="flex flex-grow items-center justify-start gap-x-8 pr-8">
        <Navigation />
      </nav>
