  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-gray-600 mt-1">CHUV Research Management Platform</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Active Studies</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-green-600">{stats.activeStudies}</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-yellow-600">{stats.pendingApproval}</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-purple-600">{stats.totalPatients}</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <span className="text-3xl font-bold text-gray-600">{stats.completedStudies}</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Overview of all clinical research studies</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <Card key={project.id} className="hover:shadow-md transition-shadow">
                  <CardContent className="pt-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-1">
                          <span className="font-medium">Study ID:</span> {project.id} | 
                          <span className="font-medium ml-2">PI:</span> {project.pi} | 
                          <span className="font-medium ml-2">Department:</span> {project.department}
                        </p>
                        <p className="text-sm text-gray-500">Started: {project.startDate} • Last updated: {project.lastUpdate}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t">
                      ...
                      <div>
                        <p className="text-xs text-gray-500 mb-1">Patient Enrollment</p>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1">
                          <AlertCircle className={`h-4 w-4 ${getRiskColor(project.riskLevel)}`} />
